...
import com.i4unetworks.weys.common.aria.ARIACipher;
...
public class AriaUtils {
	...
	public static void main(String [] args){
		...
		String a = "Hello UncleJoe 입니다.";
		try {
			String b = AriaUtils.ariaEncryptString(a);
			System.out.println(a+">>>>"+b);
			System.out.println(b+">>>>"+AriaUtils.ariaDecryptString(b));
		} catch (Exception e) {
