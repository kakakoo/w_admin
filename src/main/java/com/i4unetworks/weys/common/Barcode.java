...
public class Barcode {
	...
	public static String CreateBarcodePng(String barcodeNum, String path, String folder){
		
		String barcodeUrl = folder + "/" + barcodeNum.replace(" ", "") + ".png";
		try{
...
//		CreateBarcodePng("2019 0404 3212 3231", "/Users/dslee/Desktop/");
		CreateQRCodePng("2019 0409 3212 3231", "/Users/dslee/", "Desktop");
	}
	
	public static String CreateQrCode(int index) {
