      ...
      <div class="main_container">
		...
		<div class="my_user_content">
			...
			<div class="title" style="padding-left: 0;" >
				...
				<input type="button" class="btn btn-success" value="거래 상세 내역(포인트)">
			</div>
			...
			<form name="formBody" action="${pageContext.request.contextPath}/api/store/${storeId }/point" method="post">
			...
			<table class="list_table">
				...
				<c:forEach var="items" items="${resultList }">
					<tr>
						...
						<td style="text-align:right;">${items.point }</td>
						<td>${items.usrNick }</td>
