      ...
      <div class="main_container">
		...
		<div class="my_user_content">
			...
			<div class="title" style="padding-left: 0;" >
				...
				<input type="button" onclick="goChangePoint('${info.usrId}')" class="btn btn-success" style="color:#000;background-color:#fff;" value="포인트 내역(전환)">
				<input type="button" class="btn btn-success" value="포인트 내역(소비)">
			</div>
			...
			<table class="list_table" style="margin-top:30px;">
				...
				<tr>
					<td colspan="4">포인트 사용 이력이 없습니다.</td>
				</tr>
				</c:if>
				<c:if test="${not empty resultList }">
					<c:forEach var="items" items="${resultList }">
						<tr>
							...
							<td><nobr><font title="${items.memo }">${items.memo }</font></nobr></td>
...
function goChangePoint(usrId){
	location.href='${pageContext.request.contextPath}/api/user/' + usrId + '/cpoint';
}
