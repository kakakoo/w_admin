			...
			<table class="list_table">
				...
				<c:forEach var="items" items="${resultList }">
					<tr onclick="location.href='${pageContext.request.contextPath}/api/user/${items.usrId }/detail'">
						...
						<td><nobr><font title="${items.usrUnregDttm }">${items.usrUnregDttm }</font></nobr></td>
...
function goPage(pageNo, isSearch){
	...
	FORM_BODY.attr('action', '${pageContext.request.contextPath}/api/user/delete');
	FORM_BODY.submit();
}
</script>
</html>