    ...
    <div class="container body">
      <div class="main_container">
		...
		<div class="my_user_content">
			...
			<div class="title">
				<input type="button" onclick="location.href='${pageContext.request.contextPath}/api/notice'" class="btn btn-success" value="사용자 공지">
				<input type="button" class="btn btn-success" style="color:#000;background-color:#fff;" value="담당자 공지">
			</div>
			<div class="refresh">
				<input type="button" class="btn btn-success" onclick="location.href='${pageContext.request.contextPath}/api/notice/write?tp=admin'" value="등록">
			</div>
...
function modifyNotice(noticeId){
	location.href='${pageContext.request.contextPath}/api/notice/modify?tp=admin&id=' + noticeId;
}
